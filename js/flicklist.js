...
var api = {
  ...
  token: "849476df6873537a7d4fbb0ace4b388b", // TODO 0 add your api key DONE
  /**
...
function discoverMovies(callback, keywords) {
  ...
  // HINT: add another key/value pair to the `data` argument below  api_
...
function discoverMovies(callback, keywordsString) 
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      var keywordIDs = response.results.map(function(keywordObj)  {   //4a
...
//need to straighten out braces, parens
